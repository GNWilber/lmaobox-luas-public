...
local function LoadSettings()
    ...
    for uuid, bindData in pairs(config.keybinds or {}) do
        ...
        bindContainer.keybind = menu:AddComponent(MenuLib.Keybind("Key", bindData.key))
        bindContainer.modeCombo = menu:AddComponent(MenuLib.Combo("Mode", {"Press", "Hold", "Toggle"}))
